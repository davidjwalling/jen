...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-017.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-018.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-019.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-020.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-021.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-022.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-023.png"></td></tr></table><hr>

8. We want FreeRTOS to provide a handler for a stack overflow condition. Set "CHECK_FOR_STACK_OVERFLOW" to "Option1".

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-024.png"></td></tr></table><hr>

9. We will use both FreeRTOS and LWIP middleware. Each of them includes a distinct errno.h header. To avoid them having different values, set "USE_POSIX_ERRNO" to "Enabled".

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-025.png"></td></tr></table><hr>

10. We will perform calls to new/delete or malloc/free. On the "Advanced settings" tab, set "USE_NEWLIB_REENTRANT" to "Enabled".

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-026.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-027.png"></td></tr></table><hr>

12. On the "Mutexes" tab, add the "myMutex01" dynamic mutex.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-028.png"></td></tr></table><hr>

13. On the "Timers and Semaphores" tab, add the "myBinarySem01" binary semaphore.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-029.png"></td></tr></table><hr>

14. Select the "LWIP" category item. Check the "Enabled" check box.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-030.png"></td></tr></table><hr>

15. We'll expect file descriptors used for sockets to be non-zero. On the "Key Options" tab, set "LWIP_SOCKET_OFFSET" to 1.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-031.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-032.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-033.png"></td></tr></table><hr>

18. If prompted to open the C/C++ perspective, answer Yes.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-034.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-035.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-036.png"></td></tr></table><hr>

21. Add sample logic to the infinite loop in the StartDefaultTask function to exercise development board LEDs and the redirected printf function, which will now output to the Debug Console. Close the "main.c" file.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-037.png"></td></tr></table><hr>

### Compile and Debug the Project

22. Select the "Project" | "Build Project" menu item to build the program.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-038.png"></td></tr></table><hr>

23. Select the "Run" | "Debug Configurations" menu option to open the "Debug Configurations" window. Right-click on the "STM32 Cortex-M C/C++ Application" category and select "New Configuration". A new debugging configuration named "ayriel Debug" is created.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-039.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-040.png"></td></tr></table><hr>

25. On the "Debuggre" tab of the "Debug Configurations" window, make sure "Autostart local GDB sever" is selected. Make sure the Debug probe is set to "ST-LINK (ST-LINK GDB sever)". Make sure that Interface is set to "SWD". Check the "ST-LINK S/N" checkbox. Click the "Scan" button to locate the attached Nucleo Board and read its serial number. Click "Save" to save and close the debugging configuation.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-041.png"></td></tr></table><hr>

26. Select the "Run" | "Debug" menu item. If prompted to update the firmware of the attached ST-LINK, click Yes.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-042.png"></td></tr></table><hr>

27. If the STLinkUpgrade engine starts, click "Open in update mode" to enable firmware update. Confirm the existing and new firmware versions. Then click Upgade. Wait for the upgrade to complete and the window to report "Upgrade successful". Click the "X" at the upper-right corner of the "STLinkUpgrade" window to close it. Then select "Run" | "Debug" again to start the debugger.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-043.png"></td></tr></table><hr>

28. If Windows opens a Security Alert window and prompts you to allow the st-link_gdbserver.exe program to listen on incoming ports, check both the "Private networks" and "Public networks" checkboxes and click "Allow access".

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-044.png"></td></tr></table><hr>

29. If prompted to open the "Debug" perspective, click "Switch".

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-045.png"></td></tr></table><hr>

30. Confirm the program is at a breakpoint at the first instruction within the main routine.

<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-046.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-047.png"></td></tr></table><hr>
...
<hr><table><tr><td><img src="../images/stm32cubeide-1.8.0-win10-048.png"></td></tr></table><hr>
